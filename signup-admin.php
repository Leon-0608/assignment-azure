...
<?php
    ...
    if(null !== filter_input(INPUT_POST, 'hidden')){
       ...
       if($fname && $lname && $uname && $studID && $email && $pass1 && $pass2 && $phone){
            ...
            $q = "INSERT INTO admin(admin_fname, admin_lname, admin_uname, admin_sid, admin_email, admin_pswd, admin_tel)
            ...
            if ($result) { 
                header("Location: sign-up-success-admin.html");
            } 
        } 
    }
    else {
        ...
        <div><h1>Sign Up</h1></div>
            ...
            <div class="signup-box">
                ...
                <div class="signup">
                    ...
                    <form action="signup-admin.php" method="post" id="signup-form">
                        <fieldset>
                        ...
                        <div class="reminder">
                            <p><a class="admin" href="signup.php"><b>Are You a Normal Member? Click to Sign Up as User</b></a></P>
                        </div>
                        <br>
                        </fieldset>
                        <div class="cancel">
