...
<?php
    ...
    if(null !== filter_input(INPUT_POST, 'hidden')){
        ...
        if($uname && $pass){
            $q = "SELECT admin_uname, admin_pswd FROM admin";
        ...
        <div><h1>Log In</h1></div>
            ...
            <div class="login-box">
                ...
                <div class="login">
                    ...
                    <form action="login-admin.php" method="post" id="login-form">
                        <fieldset>
                        ...
                        <br>
                        <div class="reminder">
                            <p><a class="admin" href="login.php"><b>Are You a Normal Member? Click to Log In as User</b></a></P>
                        </div>
                        </fieldset>
                        <div class="submit">
